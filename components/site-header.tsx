...
export function SiteHeader() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      {/* Announcement Banner */}
      <div className="bg-terracotta text-white font-sans text-xs font-medium py-2 px-4 text-center tracking-wider uppercase shadow-sm">
